# Bank Marketing Dataset — Predicción de Suscripción a Depósito a Plazo

## Descripción del Proyecto

Análisis y modelado predictivo sobre el Bank Marketing Dataset del repositorio
UCI Machine Learning. El objetivo es predecir si un cliente suscribirá un depósito
a plazo a partir de datos de campañas de marketing telefónico de una institución
bancaria portuguesa (2008-2010).

Este proyecto forma parte de la evaluación del Bootcamp Data Science — Módulo 2.

---

## Estructura del Repositorio

    Bank_Marketing_Clasificacion.ipynb   — Notebook principal con el análisis completo
    bank.csv                             — Dataset utilizado (4.521 registros, 17 columnas)
...
Archivo utilizado: bank.csv — versión reducida con 4.521 registros y 17 columnas,
seleccionada específicamente para el uso con SVM dado su costo computacional.
...
- RobustScaler: balance, campaign, pdays, previous, day (distribuciones sesgadas)
...
- Octubre, diciembre y marzo son los meses con mayor tasa de conversión (mayor al 40%)
...
2. Instalar dependencias: pip install pandas numpy matplotlib seaborn scikit-learn jupyter
3. Ejecutar: jupyter notebook Bank_Marketing_Clasificacion.ipynb
